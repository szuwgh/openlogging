...
func Test_IterWalk(t *testing.T) {
	// reader := NewIndexReader("E:\\goproject\\hawkobserve\\src\\data\\01EWCS1EKD0E9GRET66QCPVD7Z")
...
func Test_IterMerge(t *testing.T) {
	// reader1 := NewIndexReader("E:\\goproject\\hawkobserve\\src\\data\\01F0B3H7419TB6CEZ6TY8E2N5P", 1614909121)
	// iter1 := reader1.Iterator()
	// reader2 := NewIndexReader("E:\\goproject\\hawkobserve\\src\\data\\01F0B3HPBD77RPCVAEJSMCM01J", 1614909121) //src\data\01EXGBNN7ZRE8904TWP351ZWSR
...
func Test_LogIter(t *testing.T) {
	dir := "E:\\goproject\\hawkobserve\\src\\data\\01EXNYVY84KSFR6BMNP9CN44TZ"
...
func Test_CompactionMerger(t *testing.T) {
	...
	var metas []ChunkMetaIndex
	m1 := ChunkMetaIndex{ChunkMeta{1, 2, 3, 4}, 0}
